<footer class="mt-20 w-full bg-black/50">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		...
		>
			...
			<!--End Col-->
			<div class="text-center sm:text-left lg:mx-auto">
				<h4 class="text-white-900 mb-7 text-lg font-medium">Pages</h4>
				<ul class="text-sm transition-all duration-500">
					<li class="mb-6">
						<a href="/" class="hover:text-white-900 text-gray-600">Home</a>
					</li>
					<li class="mb-6">
						<a href="https://sethu.ac.in/dept/CSD/" class=" hover:text-white-900 text-gray-600"
							>About</a
						>
					</li>
					<li class="mb-6">
